...
export const optionsCommands = new Map<OptionType, OptionItem>([
    ...
    [OptionType.SkipImport, { commands: ['--skip-import'], type: 'True | False', description: 'Flag to skip the module import' }],
    [OptionType.Selector, { commands: ['--selector'], description: 'The selector to use for the component.' }],
    [OptionType.Module, { commands: ['--module', '-m'], description: 'Allows specification of the declaring module.' }],
    [OptionType.Export, { commands: ['--export'], type: 'True | False', description: 'Specifies if declaring module exports the component.' }],
